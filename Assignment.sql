...
#Querry No:- Count the number of Salesperson whose name begin with ‘a’/’A’.
SELECT COUNT(SNAME)
FROM SALESPEOPLE
WHERE SNAME LIKE 'a%' OR 'A%';

#  Querry No:- Display all the Salesperson whose all orders worth is more than Rs. 2000.
...
# Querry No3:- Count the number of Salesperson belonging to Newyork.
